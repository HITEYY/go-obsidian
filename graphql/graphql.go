...
// Package graphql provides a GraphQL interface to Obsidian node data.
package graphql
...
// Account represents an Obsidian account at a particular block.
type Account struct {
	r             *Resolver
...
// Transaction represents an Obsidian transaction.
...
// Block represents an Obsidian block.
...
type CallData struct {
	From                 *common.Address // The Obsidian address the call is from.
	To                   *common.Address // The Obsidian address the call is to.
