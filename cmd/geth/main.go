...
import (
	...
	"github.com/HITEYY/go-obsidian/console/prompt"
	"github.com/HITEYY/go-obsidian/eth/downloader"
	"github.com/HITEYY/go-obsidian/ethclient"
	"github.com/HITEYY/go-obsidian/internal/debug"
	...
	_ "github.com/HITEYY/go-obsidian/eth/tracers/js"
	_ "github.com/HITEYY/go-obsidian/eth/tracers/live"
	_ "github.com/HITEYY/go-obsidian/eth/tracers/native"
...
func prepare(ctx *cli.Context) {
	...
	// If we're a full node on Obsidian without --cache specified, bump default cache allowance
	if !ctx.IsSet(utils.CacheFlag.Name) && !ctx.IsSet(utils.NetworkIdFlag.Name) {
		...
		if !ctx.IsSet(utils.HoleskyFlag.Name) &&
			...
			// Nope, we're really on Obsidian. Bump that cache up!
			log.Info("Bumping default cache on Obsidian", "provided", ctx.Int(utils.CacheFlag.Name), "updated", 4096)
