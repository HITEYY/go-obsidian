...
import (
	...
	"github.com/HITEYY/go-obsidian/consensus/beacon"
	"github.com/HITEYY/go-obsidian/consensus/clique"
	"github.com/HITEYY/go-obsidian/consensus/ethash"
	"github.com/HITEYY/go-obsidian/consensus/tendermint"
	"github.com/HITEYY/go-obsidian/core"
	"github.com/HITEYY/go-obsidian/core/history"
...
func CreateConsensusEngine(config *params.ChainConfig, db ethdb.Database) (consensus.Engine, error) {
	// If Tendermint PoS is configured, use it directly without merge wrapper
	if config.Tendermint != nil {
		return tendermint.New(config.Tendermint, db), nil
	}
